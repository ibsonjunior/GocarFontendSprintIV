      ...
      fetch(`https://gocarback.ctdprojetos.com.br/products`, {
        ...
        .then((res) => {
          if (!res.ok) {
            ...
            setTimeout(() => {
              window.location.href = "/registered-product";
            }, 0);
          }
        })
          ...
          <div className="polices_input">
            ...
            <div className="container">
              ...
              <div className="police_container">
                ...
                <div className="police_description">
                  <p>
                    O locatário/condutor deverá pagar um taxa de seguro, no qual
                    será entregue se não houver nenhum acidente.
                  </p>
                </div>
              </div>
              <div className="police_container">
                ...
                <div className="police_description">
                  <p>
                    O locatário deverá apresentar seu documento de habilitação
                    original, emitido há mais de 2 anos (CNH Definitiva), válido
                    e dentro do prazo de vencimento.
                  </p>
                </div>
              </div>
              <div className="police_container">
                ...
                <div className="police_description">
                  <p>
                    Dois dias antes da data de entrega do carro, será hratuito o
                    cancelamento, menos que isso será cobrada um taxa de
                    cancelamento de 5% do valor.
                  </p>
                </div>
              </div>
            </div>
